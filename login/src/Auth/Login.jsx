...
const Login = () => {
  return (
    <main className="relative flex min-h-screen items-center justify-center bg-radial from-[#0085FF] to-[#003465] overflow-hidden">
      ...
      <div className="hidden sm:block absolute bottom-0 left-4 w-40 h-40 md:w-60 md:h-60 lg:w-100 lg:h-100 mix-blend-overlay opacity-70">
        <img
          src={login1}
      ...
      <section className="relative bg-transparent backdrop-blur-md border border-white/10 shadow-2xl w-[90%] max-w-4xl flex justify-center items-center py-8 rounded-2xl min-h-[80vh] my-8 mx-4">
        ...
        <div className="hidden lg:block absolute top-50 left-25 w-40 h-40 mix-blend-lighten opacity-50">
          <img
            src={login3}
            alt="decorative spiral"
            className="w-full h-auto object-cover drop-shadow-lg"
        ...
        <div
          className="w-full max-w-sm rounded-2xl bg-transparent backdrop-blur-2xl  border border-white/20 shadow-2xl py-6 md:py-8 text-white px-6 md:px-16"
